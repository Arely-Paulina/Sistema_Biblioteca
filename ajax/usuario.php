	...
	case 'listar':
		$rspta=$usuario->listar();
 		...
 		while ($reg=$rspta->fetch_object()){
 			$data[]=array(
 				"0"=>$reg->idusuario,
        				"1"=>'<button class="btn btn-info" onclick="mostrar('.$reg->idusuario.')"><i class="fas fa-edit"></i></button> <button class="btn btn-primary" onclick="eliminarFila('.$reg->idusuario.')"><i class="fa fa-trash"></button>',
